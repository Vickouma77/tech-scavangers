<template>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Learning Income Generation Ideas Through Tech</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">We offer detailed and comprehensive insights to guide you in making the life changing decision of finding your niche and using it to attain financial freedom though tech.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Technology</h3>
